...
<div class="bg-white">
    <div class="container">
        <div class="my-4 text-center">
            ...
            <a href="./?act=commentProduct&id=<?php echo $detailProducts['id_sanPham']?>"><button class="mt-5 btn btn-outline-secondary rounded w-25 text-muted hover-border-primary ms-3">Đánh giá sản phẩm</button></a>
        </div>
